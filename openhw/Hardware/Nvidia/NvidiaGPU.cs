...
namespace FuyukaiHWMonitor.Hardware.Nvidia
{
    public class NvidiaGPU : Hardware
    {
        ...
        private Sensor memoryUsed;
        private Sensor memoryFree;
        private Sensor memoryAvail;
        private Control fanControl;
        private uint busId = 0;
        private nvmlPciInfo pciInfo;


        public NvidiaGPU(int adapterIndex, NvPhysicalGpuHandle handle,
          NvDisplayHandle? displayHandle,
          nvmlDevice nvmlDeviceHandle,
          ISettings settings)
      ...
      ISettings settings)
        ...
        public int CurrentAdapterIndex()
        {
            return adapterIndex;
        }
