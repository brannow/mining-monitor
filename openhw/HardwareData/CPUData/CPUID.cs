...
namespace FuyukaiLib.HardwareData.CPUData
{
    ...
    internal class CPUID
    {
        ...
        private readonly Vendor vendor = CPUData.Vendor.Unknown;
        ...
        public CPUID(int thread)
        {
                ...
                out eax, out ebx, out ecx, out edx, mask))
            {
                ...
                {
                    case "GenuineIntel":
                        vendor = CPUData.Vendor.Intel;
                        break;
                    case "AuthenticAMD":
                        vendor = CPUData.Vendor.AMD;
                        break;
                    default:
